...
public class XMLReaderForTenant implements MessageBodyReader<Tenant> {
    ...
    @Override
    public Tenant readFrom(Class<Tenant> type, Type genericType, Annotation[] annotations, MediaType mediaType, MultivaluedMap<String, String> httpHeaders, InputStream entityStream) throws IOException, WebApplicationException {
        try {
            ...
            JAXBElement<Tenant> jaxbObject = (JAXBElement<Tenant>) m.unmarshal(new StringReader(en));
