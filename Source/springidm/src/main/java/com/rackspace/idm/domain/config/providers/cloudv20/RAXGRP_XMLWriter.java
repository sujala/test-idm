...
@Component
public class RAXGRP_XMLWriter extends NamespacePrefixMapper implements
        MessageBodyWriter<Object> {
    public static final Logger LOG = Logger.getLogger(RAXGRP_XMLWriter.class);

    @Resource(name = "raxgrpNsPrefixMap")
    private Map<String, String> raxgrpNsPrefixMap;
...
//
    ...
    public String getPreferredPrefix(String namespaceUri, String suggestion,
        ...
        return raxgrpNsPrefixMap.get(namespaceUri);
    }

    public void setNsPrefixMap(Map<String, String> nsPrefixMap) {
        this.raxgrpNsPrefixMap = nsPrefixMap;
    }
}
