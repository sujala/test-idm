...
@Component
public class RAXKSKEY_XMLWriter extends NamespacePrefixMapper implements
        MessageBodyWriter<Object> {
    public static final Logger LOG = Logger.getLogger(RAXKSKEY_XMLWriter.class);

    @Resource(name = "raxkskeyNsPrefixMap")
    private Map<String, String> raxkskeyNsPrefixMap;
