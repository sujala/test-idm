...
/**
 * <p>
 * Java class for CustomerIdConflictFault complex type.
 * 
 * <p>
...
@XmlType(name = "CustomerIdConflictFault")
@XmlRootElement(name = "customerIdConflict")
@Mapped(namespaceMap = {@XmlNsMap(namespace = GlobalConstants.XML_NAMESPACE, jsonName = GlobalConstants.JSON_NAMESPACE)})
public class CustomerIdConflict extends IdmFault {
