...
/**
 * <p>
 * Java class for UsernameConflictFault complex type.
 * 
 * <p>
...
@XmlType(name = "UsernameConflictFault")
@XmlRootElement(name = "usernameConflict")
@Mapped(namespaceMap = {@XmlNsMap(namespace = GlobalConstants.XML_NAMESPACE, jsonName = GlobalConstants.JSON_NAMESPACE)})
public class UsernameConflict extends IdmFault {
