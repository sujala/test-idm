			...
			<body>
				<div align="center">
					...
					<table border="1" width="70%" cellpadding="8" style="border:1px solid #c3c3c3; border-collapse:collapse; font-family:verdana">
						...
						<tr height="40">
							<td>
								<xsl:value-of select="sp:contract/@version" />
							</td>
							<td>
								<xsl:value-of select="sp:contract/@status" />
							</td>
							<td>
								<xsl:value-of select="sp:contract/@updated" />
							</td>
							<td>
								<xsl:for-each select="sp:contract/atom:link">
									<link>
							...
							<td>
								<xsl:for-each select="sp:contract/sp:media-types/sp:media-type">
