...
public class DefaultAuthenticationServiceTest {
    ...
    DefaultAuthenticationService defaultAuthenticationService = new DefaultAuthenticationService(null,null,null,null,applicationDao,null,userDao,null,null);
    ...
    @Test
    public void authenticate_withRSACredentials_callsRSAClient() throws Exception {
        ...
        verify(rsaClient).authenticate("u","p");
    }
}
