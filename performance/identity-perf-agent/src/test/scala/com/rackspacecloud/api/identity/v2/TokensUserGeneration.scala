...
object TokensUserGeneration {
  ...
  try{
   ...
   val usersFeeder_v20_validate_gen = csv(DATA_LOCATION + "data/identity/users.dat").circular
def v20_user_gen_tokens = {
    feed(TokensUserGeneration.usersFeeder_v20_validate_gen)
