...
class DefaultUserAuthValidate extends Simulation {
  val conf = ConfigFactory.load()

  // V20 Authenticate
  val V20_AUTHENTICATE_APIKEY_USERS_PER_SEC : Double =  conf.getDouble("soa.v20_authenticate_apikey_default_users.users_per_sec")

  val v20_apikey_auth_scn = Identity.v20_apikey_auth_default_user


  // V20 Validate
  val V20_VALIDATE_USERS_PER_SEC : Double =  conf.getDouble("soa.v20_validate_default_users.users_per_sec")

  val v20_token_validate_scn = Identity.v20_token_validate_default_user
