...
class CloudIdentityAdminAccessibilityTest extends RootServiceTest {
    @Shared CloudIdentityAdminAccessibility accessibility

    def setupSpec() {
        accessibility = new CloudIdentityAdminAccessibility()
    }
