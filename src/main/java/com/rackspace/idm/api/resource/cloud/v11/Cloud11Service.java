...
public interface Cloud11Service {
    ...
    Response.ResponseBuilder deleteUser(HttpServletRequest request, String userId, HttpHeaders httpHeaders) throws IOException, JAXBException;
    ...
    Response.ResponseBuilder getBaseURLById(HttpServletRequest request, String baseURLId, String serviceName, HttpHeaders httpHeaders) throws IOException;
