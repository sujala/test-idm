...
//
//        try {
//            //1. authenticate user making request
//            authenticateCloudAdminUser(request);
//
//            //2. validate object. TODO: move validation to domain level, so can be in one place
//            validator.validate11User(user);
//
//            //3. if password is empty, generate random password.
//            //TODO: implement this logic
//
//            //4. if api key is empty, generate random api key
//            if(getGenerateApiKeyUserForCreate() && StringUtils.isBlank(user.getKey())){
//                user.setKey(UUID.randomUUID().toString().replaceAll("-", ""));
//            }
//
//            //5. validate mossoId/domain id exists. Also trim value
...
//
//            //=================================================================================================
//            //6. Based on the caller making the call, apply the following rules to the user being created
//            //      a. identity:user-admin, identity:user-manage
//            //         i.   set mosso id to that of caller
//            //         ii.  set nast id to that of caller
//            //         iii. set domain id to that of caller
//            //         iv.  set default region to region of caller's domain (admin user domain for now)
//            //      b. identity:service-admin
//            //         i.   domain id must be null.
//            //         ii.  user created must be identity:admin
//            //      c. identity:admin
//            //         i.   domain must NOT be null
//            //         ii.  user created must be identity:user-admin
//            //=================================================================================================
//            //TODO: implement this logic
//
//            //TODO: why do we need to do this? why do we need to set it explicitly to null
...
//
//            //===========================================================
//            //7. if domain does not exist, create domain by default
//            //===========================================================
...
//
//            //===========================================================
//            //8. validate the default region that is set correctly
//            //===========================================================
//            //TODO: implement this logic
//
//            //===========================================================
//            //9. add user to system
//            //===========================================================
//            userService.addUser(userDO);
//            userDO = userService.getUserById(userDO.getId());
//
//            //===========================================================
//            //10. If user is first user in domain (identity:user-admin),
//            //    By default create two tenants representing the
//            //    mosso tenant and the nast tenant. Give user roles on
//            //    both tenants.
//            //===========================================================
...
//
//            //===========================================================
//            //11. Add the Tenants to the domain
//            //===========================================================
...
//
//            //TODO: don't think we want to support this for now. Client's can't programmatically add. Need to verify
//            // endpoints that user should have for now.
...
//
//                    //TODO: Determine what the heck this logic if for!!!!!!!! Seems like we want to rollback
//                    //error if baseurl not found. This should be part of payload validation. Also error returned
//                    //should really be a bad request exception.
...
//
//            //TODO: check if we still need to do this, after global endpoint story goes out
