...
public class DelegateCloud11Service implements Cloud11Service {
    ...
    @Override
    public Response.ResponseBuilder authenticate(HttpServletRequest request, UriInfo uriInfo,
    ...
    @Override
    public Response.ResponseBuilder adminAuthenticate(HttpServletRequest request, UriInfo uriInfo,
                                                      HttpHeaders httpHeaders, String body)
            throws IOException, JAXBException, URISyntaxException {
        JAXBElement<? extends Credentials> cred = extractCredentials(httpHeaders, body);
    ...
    private ResponseBuilder authenticateByCred(HttpServletRequest request, UriInfo uriInfo,
