...
@Component
public class OSKSADM_XMLWriter extends NamespacePrefixMapper implements
        MessageBodyWriter<Object> {
    public static final Logger LOG = Logger.getLogger(OSKSADM_XMLWriter.class);

    @Resource(name = "osksadmNsPrefixMap")
    private Map<String, String> osksadmNsPrefixMap;
