...
public abstract class LdapRepository {
    ...
    public static final String ATTR_USER_ADMIN_DN = "rsUserAdminDN";
    ...
    public static final String ATTR_PHONE_PIN = "rsPhonePin";
    public static final String ATTR_PHONE_PIN_AUTH_FAILURE_COUNT = "rsPhonePinAuthenticationFailureCount";
    public static final String ATTR_PHONE_PIN_AUTH_LAST_FAILURE_DATE = "rsPhonePinAuthenticationLastFailureTimestamp";
    ...
    protected static final String[] ATTR_USER_SEARCH_ATTRIBUTES_NO_PWD_HIS = {
            ...
            ATTR_INVITE_CREATED_DATE, ATTR_REGISTRATION_CODE, ATTR_UNVERIFIED, ATTR_PHONE_PIN, ATTR_PHONE_PIN_AUTH_FAILURE_COUNT, ATTR_PHONE_PIN_AUTH_LAST_FAILURE_DATE};
