...
@Getter
@Setter
@LDAPObject(structuralClass=LdapRepository.OBJECTCLASS_USERSCOPEACCESS,requestAllAttributes=true, auxiliaryClass = LdapRepository.OBJECTCLASS_METADATA)
public class UserScopeAccess extends ScopeAccess implements BaseUserToken, Metadata {
