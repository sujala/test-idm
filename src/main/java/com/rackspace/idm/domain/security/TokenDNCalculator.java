...
public final class TokenDNCalculator {
    ...
    private static final String ID_FORMAT = "([a-zA-Z0-9\\-\\_]+)";
    private static final String FEDERATED_USERNAME_FORMAT = "(.*)";
    ...
    public static final Pattern FEDERATED_USER_TOKEN_DN_PATTERN = Pattern.compile(String.format(FEDERATED_USER_TOKEN_DN_FORMAT, ID_FORMAT, FEDERATED_USERNAME_FORMAT, ID_FORMAT));
