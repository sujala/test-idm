...
public class Constants {
    ...
    public static final String ENDPOINT_ASSIGNMENT_RULES = "endpointAssignmentRules";
    public static final String TENANT_TYPE_ENDPOINT_RULES = "tenantTypeEndpointRules";
    public static final String RAX_AUTH_ENDPOINT_ASSIGNMENT_RULES = "RAX-AUTH:" + ENDPOINT_ASSIGNMENT_RULES;
    public static final String RAX_AUTH_EP_ASSIGNMENT_RULES_TT_RULE_ENDPOINT_TEMPLATES_PATH = RAX_AUTH_ENDPOINT_ASSIGNMENT_RULES + "." + TENANT_TYPE_ENDPOINT_RULES +  JSONConstants.ENDPOINT_TEMPLATES;
    public static final String RAX_AUTH_EP_ASSIGNMENT_RULES_TT_RULE_ENDPOINT_TEMPLATE_PATH = RAX_AUTH_ENDPOINT_ASSIGNMENT_RULES + "." + TENANT_TYPE_ENDPOINT_RULES +  JSONConstants.ENDPOINT_TEMPLATE;
