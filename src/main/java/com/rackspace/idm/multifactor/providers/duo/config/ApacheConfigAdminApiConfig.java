 ...
 */
@Component
public class ApacheConfigAdminApiConfig extends ApacheConfigDuoSecurityConfig implements AdminApiConfig {
    ...
    @Autowired
    public ApacheConfigAdminApiConfig(Configuration globalConfig) {
        super(globalConfig);
    }
