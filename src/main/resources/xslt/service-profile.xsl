		...
		<html>
			<body>
				...
				<div align="center">
					<table>
						<tr>
							<td><img src="/docs/xslt/psd_erl_13.gif" height="60px"></img></td>
							<td><span style="font-family:verdana"><h1>Service Profile - <xsl:value-of select="sp:service-profile/@name" /></h1></span></td>
						</tr>
					</table>
					
					<table cellspacing="5" cellpadding="5" border="1" width="70%" style="border:1px solid #000000;border-collapse:collapse;font-family:verdana">
