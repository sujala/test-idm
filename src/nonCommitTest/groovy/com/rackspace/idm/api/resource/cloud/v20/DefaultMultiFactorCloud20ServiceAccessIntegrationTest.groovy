...
class DefaultMultiFactorCloud20ServiceAccessIntegrationTest extends RootIntegrationTest  {
    ...
    def setup() {
        ...
        serviceAdmin = utils.getUserByName(Constants.SERVICE_ADMIN_USERNAME)
        serviceAdmin2 = utils.getUserByName(Constants.SERVICE_ADMIN_2_USERNAME)

        utils.addApiKeyToUser(utils.getUserByName(Constants.SERVICE_ADMIN_2_USERNAME), Constants.SERVICE_ADMIN_2_API_KEY)
        serviceAdminToken2 = utils.authenticateApiKey(Constants.SERVICE_ADMIN_2_USERNAME, Constants.SERVICE_ADMIN_2_API_KEY).token.id
        ...
        utils.addRoleToUser(userManage3, Constants.USER_MANAGE_ROLE_ID)
