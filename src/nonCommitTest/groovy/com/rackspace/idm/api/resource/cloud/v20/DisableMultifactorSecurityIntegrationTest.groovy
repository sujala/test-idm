...
class DisableMultifactorSecurityIntegrationTest extends RootIntegrationTest {
    ...
    def setup() {
        ...
        serviceAdmin1 = utils.getUserByName(Constants.SERVICE_ADMIN_USERNAME, utils.getServiceAdminToken())
        serviceAdmin2 = utils.getUserByName(Constants.SERVICE_ADMIN_2_USERNAME, utils.getServiceAdminToken())
        serviceAdmin1Token = utils.getToken(Constants.SERVICE_ADMIN_USERNAME, Constants.SERVICE_ADMIN_PASSWORD)
        serviceAdmin2Token = utils.getToken(Constants.SERVICE_ADMIN_2_USERNAME, Constants.SERVICE_ADMIN_2_PASSWORD)
    }
