...
class FederatedRackerIntegrationTest extends RootIntegrationTest {
    ...
    def "racker populated appropriately from saml and edir w/ no EDIR groups."() {
        ...
        def samlAssertionPassword = new SamlFactory().generateSamlAssertionStringForFederatedRacker(Constants.RACKER_IDP_URI, username, expSecs, SAMLConstants.PASSWORD_PROTECTED_AUTHCONTEXT_REF_CLASS);
        def samlAssertionToken = new SamlFactory().generateSamlAssertionStringForFederatedRacker(Constants.RACKER_IDP_URI, username, expSecs, SAMLConstants.TIMESYNCTOKEN_PROTECTED_AUTHCONTEXT_REF_CLASS);
    ...
    def "Validating token received matches initial federated auth response."() {
        ...
        def samlAssertion = new SamlFactory().generateSamlAssertionStringForFederatedRacker(Constants.RACKER_IDP_URI, username, 100, SAMLConstants.PASSWORD_PROTECTED_AUTHCONTEXT_REF_CLASS);
    ...
    def "Federated racker auth matches regular racker auth."() {
        ...
        samlAuthResponse.user.federatedIdp == Constants.RACKER_IDP_URI
    ...
    def "Invalid SAML signature results in 400"() {
        ...
        Response samlAssertion = samlFactor.generateSamlAssertionResponseForFederatedRacker(Constants.RACKER_IDP_URI, username, expSecs);
        Response samlAssertion2 = samlFactor.generateSamlAssertionResponseForFederatedRacker(Constants.RACKER_IDP_URI, username, expSecs+100);
    ...
    def "When receive samlResponse for non-existant racker, throw 400"() {
        ...
        String samlAssertion = samlFactor.generateSamlAssertionStringForFederatedRacker(Constants.RACKER_IDP_URI, username, expSecs);
    ...
    def void verifyResponseFromSamlRequest(AuthenticateResponse authResponse, expectedUserName, AuthenticatedByMethodGroup authByGroup, List<String> expectedEDirRoleNames = Collections.EMPTY_LIST) {
        ...
        assert authResponse.user.federatedIdp == Constants.RACKER_IDP_URI
