...
abstract class AbstractFederatedAuthRequestGenerator<T> {
    private static final Logger logger = Logger.getLogger(AbstractFederatedAuthRequestGenerator.class)

    Credential brokerCredential
    Credential originCredential

    SamlCredentialUtils samlCredentialUtils = new SamlCredentialUtils()
    ...
    AbstractFederatedAuthRequestGenerator(String brokerPublicKeyLocation, String brokerPrivateKeyLocation, String originPublicKeyLocation, String originPrivateKeyLocation) {
    ...
    AbstractFederatedAuthRequestGenerator(Credential brokerCredential, Credential originCredential) {
    ...
    /**
     * Creates a multi-valued map of attributes to add as attributes.
     * @param genRequest
     * @return
     */
    abstract HashMap<String, List<String>> createAttributes(T genRequest)
