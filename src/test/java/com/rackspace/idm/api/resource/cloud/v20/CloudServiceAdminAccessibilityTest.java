 ...
 */
public class CloudServiceAdminAccessibilityTest{
    ...
    public void setUp(){
        ...
        cloudUserAccessibility = new CloudServiceAdminAccessibility(tenantService, domainService, authorizationService, userService, config, objFactory, scopeAccess);
