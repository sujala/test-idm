 ...
 */
public class CloudUserAdminAccessibilityTest extends TestCase {
    ...
    public void setUp(){
        ...
        cloudUserAccessibility = new CloudUserAdminAccessibility(tenantService, domainService, authorizationService, userService, config, objFactory, scopeAccess);

    }

    @Test
    public void testHasAccess_userAdmin_onDefaultUser() throws Exception {
        User user1 = new User();
        User user2 = new User();
    ...
    @Test
    public void testHasAccess_userAdmin_notSameDomain() throws Exception {
        User user1 = new User();
        User user2 = new User();
        List<TenantRole> tenantRoleList = new ArrayList<TenantRole>();
        TenantRole role = new TenantRole();
