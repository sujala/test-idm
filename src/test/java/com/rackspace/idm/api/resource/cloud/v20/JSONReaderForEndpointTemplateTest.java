...
public class JSONReaderForEndpointTemplateTest {
    ...
    public void getEndpointTemplateFromJSONString_withEmptyJSON_returnsNewEndpointTemplate() throws Exception {
        EndpointTemplate endpointTemplateFromJSONString = JSONReaderForOsKsCatalogEndpointTemplate.getEndpointTemplateFromJSONString("{ }");
    ...
    public void getEndpointTemplateFromJSONString_withValidJSON_setsEndpointId() throws Exception {
        EndpointTemplate endpointTemplateFromJSONString = JSONReaderForOsKsCatalogEndpointTemplate.getEndpointTemplateFromJSONString(endpointTemplateJSON);
    ...
    public void getEndpointTemplateFromJSONString_withValidJSONAndNoEndpointId_setsNullEndpointID() throws Exception {
        EndpointTemplate endpointTemplateFromJSONString = JSONReaderForOsKsCatalogEndpointTemplate.getEndpointTemplateFromJSONString(emptyEndpointTemplateJSON);
