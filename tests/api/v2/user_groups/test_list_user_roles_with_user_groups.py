...
class TestListUsersWithUserGroups(usergroups.TestUserGroups):
    ...
    @classmethod
    def setUpClass(cls):
        super(TestListUsersWithUserGroups, cls).setUpClass()

    def setUp(self):
        super(TestListUsersWithUserGroups, self).setUp()
    ...
    def test_list_user_roles_no_groups(self):
        ...
        list_role_names = [k[const.NAME] for k in resp.json()[const.ROLES]]
    ...
    def test_list_user_roles_with_user_group_with_roles(self):
        ...
        self.assertEqual(resp.status_code, 200)
        role_name_list = [k[const.NAME] for k in resp.json()[const.ROLES]]
    ...
    def tearDown(self):
        super(TestListUsersWithUserGroups, self).tearDown()
    ...
    def tearDownClass(cls):
        super(TestListUsersWithUserGroups, cls).tearDownClass()
