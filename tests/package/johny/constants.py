...
LIST_ENDPOINTS_FOR_TENANT_URL = '/tenants/{tenant_id}/OS-KSCATALOG/endpoints'
...
LIST_DOMAINS_FOR_USER = '/users/{userId}/RAX-AUTH/domains'
...
BLACKLIST_CHECK_MSG = 'blacklistCheckMessage'
...
COMPOSITION_CHECK_MSG = 'compositionCheckMessage'
...
INCORRECT_PIN_MSG = 'Incorrect Phone PIN.'
INDETERMINATE = 'INDETERMINATE'
INDETERMINATE_RETRY = 'INDETERMINATE-RETRY'
INDETERMINATE_ERROR = 'INDETERMINATE-ERROR'
...
KEY = 'key'
KEY_URI = 'keyUri'
LOCKED_PIN_MSG = 'User\'s PIN is locked.'
...
NON_PASSING_CHECKS = 'nonPassingCheckNames'
OBSERVER = 'observer'
ON_ROLE = 'onRole'
...
RAX_AUTH = 'RAX-AUTH'
NS_TYPES = RAX_AUTH_TYPES = 'RAX-AUTH:types'
...
RAX_AUTH_DOMAINS = 'RAX-AUTH:domains'
...
RAX_AUTH_PHONE_PIN = 'RAX-AUTH:' + PHONE_PIN
RAX_AUTH_PHONE_PIN_STATE = 'RAX-AUTH:' + PHONE_PIN_STATE
...
RAX_AUTH_VALIDATE_PASSWORD = 'RAX-AUTH:validatePassword'
RAX_AUTH_VALIDATE_PASSWORD_REQ = 'RAX-AUTH:validatePasswordRequest'
RAX_AUTH_VERIFY_PIN_RESULT = 'RAX-AUTH:verifyPhonePinResult'
...
IDENTITY_RS_DOMAIN_ADMIN_ROLE_ID = "19"
IDENTITY_RS_DOMAIN_ADMIN_ROLE_NAME = 'identity:rs-domain-admin'
...
PHONE_PIN_ADMIN_ROLE_NAME = 'identity:phone-pin-admin'
