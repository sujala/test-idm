...
class IdentityAPIClient(client.AutoMarshallingHTTPClient):
    ...
    def auth_with_mfa_cred(self, session_id, pass_code, domain_id=None,
                           tenant_id=None,
        ...
        req_obj = requests.AuthenticateWithMFA(
            pass_code=pass_code, domain_id=domain_id, tenant_id=tenant_id,
    ...
    def list_tenants_in_domain(
            self, domain_id, option=None, requestslib_kwargs=None):
        ...
        url = self.url + const.LIST_TENANTS_IN_DOMAIN_URL.format(
            domainId=domain_id)
        resp = self.request('GET', url, params=option,
                            requestslib_kwargs=requestslib_kwargs)
